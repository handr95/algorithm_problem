 ...
 */
public class PersonalDataExpireDate {
    public int[] personalDateExpireDate(String today, String[] terms, String[] privacies) {
        ...
        final String[] todayInfo = today.split("\\.");
        final int todayYear = Integer.parseInt(todayInfo[0]);
        final int todayMonth = Integer.parseInt(todayInfo[1]);
        final int todayDay = Integer.parseInt(todayInfo[2]);

        int index = 0;
        List<Integer> expirePerson = new ArrayList<>();
        for (String privacy : privacies) {
            index++;

            String[] privacyInfo = privacy.split(" ");
            String[] date = privacyInfo[0].split("\\.");
            int expireMonth = termMap.get(privacyInfo[1]);
            int plusYear = expireMonth/12;
            int plusMonth = expireMonth%12;

            int compareYear = Integer.parseInt(date[0]) + plusYear;
            int compareMonth = Integer.parseInt(date[1]) + plusMonth;
            int compareDay = Integer.parseInt(date[2]);
            if (compareMonth > 12) {
                compareYear ++;
                compareMonth -= 12;
            }
        ...
        int[] result = new int[expirePerson.size()];
        int resultIndex = 0;
        for (Integer person : expirePerson) {
